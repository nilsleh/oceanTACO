...
build those with :mod:`ocean_taco_benchmarks.climatebenchpress.package_standardized` (or the
full :mod:`ocean_taco_benchmarks.climatebenchpress.run_pipeline`).
"""
...
def _register_codecs():
    ...
    import ocean_taco_benchmarks.climatebenchpress.oceantaco_codec  # noqa: F401
