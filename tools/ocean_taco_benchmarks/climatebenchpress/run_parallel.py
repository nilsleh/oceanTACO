...
from ocean_taco_benchmarks.climatebenchpress.run_cbp_benchmark import (
    ...
    *,
    ...
    inner = [
        *_python_launcher(conda_env, python_exe),
        "-u",
        "-m",
        "ocean_taco_benchmarks.climatebenchpress.run_cbp_benchmark",
        "--benchmark-root",
        str(benchmark_root),
...
def run_parallel(
    ...
    *,
    ...
    if run_analysis:
        ...
        analyze_cmd = [
            *_python_launcher(conda_env, python_exe), "-u", "-m",
            "ocean_taco_benchmarks.climatebenchpress.analyze_results",
            "--benchmark-root", str(benchmark_root),
        ]
