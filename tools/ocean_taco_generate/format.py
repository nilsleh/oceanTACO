...
import pandas as pd
from ocean_taco_benchmarks.climatebenchpress.config import DEFAULT_BENCHMARK_MODALITIES
from ocean_taco_benchmarks.climatebenchpress.export_subset import (
    BenchmarkTileExporter,
    write_manifest,
)

from ocean_taco_generate.format_loaders import (
    load_glorys_data,
    load_l3_sst_data,
    load_l4_ssh_data,
    load_l4_sss_data,
...
from ocean_taco_generate.new_format_ssh_data import (
    process_l3_ssh_data,
...
# python tools/ocean_taco_generate/format.py --date-min 2023-03-29 --date-max 2023-04-15 --data-dir data/new_ssh_dataset --output-dir data/new_ssh_dataset_formatted_region --inventory-path data/new_ssh_dataset_formatted_region/file_collection_swot_period.parquet
